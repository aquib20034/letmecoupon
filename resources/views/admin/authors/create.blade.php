...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.authors.store") }}" enctype="multipart/form-data" id="authorForm">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('facebook_url') ? 'is-invalid' : '' }}" type="facebook_url" name="facebook_url" id="facebook_url" value="{{ old('facebook_url', '') }}">
            </div>
            <div class="form-group">
                <label for="instagram_url">{{ trans('cruds.author.fields.instagram_url') }}</label>
                <input class="form-control {{ $errors->has('instagram_url') ? 'is-invalid' : '' }}" type="instagram_url" name="instagram_url" id="instagram_url" value="{{ old('instagram_url', '') }}">
            </div>
            <div class="form-group">
                <label for="linkedin_url">{{ trans('cruds.author.fields.linkedin_url') }}</label>
                <input class="form-control {{ $errors->has('linkedin_url') ? 'is-invalid' : '' }}" type="linkedin_url" name="linkedin_url" id="linkedin_url" value="{{ old('linkedin_url', '') }}">
            </div>
            <div class="form-group">
                <label for="twitter_url">{{ trans('cruds.author.fields.twitter_url') }}</label>
                <input class="form-control {{ $errors->has('twitter_url') ? 'is-invalid' : '' }}" type="twitter_url" name="twitter_url" id="twitter_url" value="{{ old('twitter_url', '') }}">
            </div>
            <div class="form-group">
