<div class="discountCardStyle1 js-discountCard {{ $coupon['code'] ? 'only-codes' : 'only-deals' }} coupon-box">
        ...
        <div class="discountCard__wrapper">
            ...
            <div class="discountCard__cta">
                <a class="baseurlappend" data-id="{{ encrypt($coupon['id']) }}" data-store="{!! !empty($coupon['affiliate_url'])
                    ...
                    <span class="icon">
                        <i class="x_arrow-right-square-1"></i>
                    </span>
                </a>
            </div>
        </div>
...
{{-- <div class="detail-box">
    <h3 class="title">{!! trans('sentence.terms_and_condition') !!}</h3>
    {!! $coupon['description'] !!}
</div> --}}
