    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.stores.store") }}" enctype="multipart/form-data" id="storesForm">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rating') ? 'is-invalid' : '' }}" type="number" name="rating" id="rating" value="{{ old('rating', '') }}" min="1" max="5" >
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('affiliate_url_update') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="affiliate_url_update" id="affiliate_url_update" value="1" {{ old('affiliate_url_update', 0) == 1 || old('affiliate_url_update') === 0 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('flashbanner') ? 'is-invalid' : '' }}" name="flashbanner" id="flashbanner">{{ old('flashbanner') }}</textarea>
            ...
            <div class="faq-question-answer">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('faq_title') ? 'is-invalid' : '' }}" type="text" name="faq_title" id="faq_title" value="{{ old('faq_title', '') }}" disabled>
                ...
                <div class="form-group">
                    <button class="btn btn-success" type="button" id="addMoreBttn" onclick="addMore(1)" disabled>
