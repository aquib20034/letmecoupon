        ...
        <div class="section">
            ...
            <section class="section pd-none onlyDesktop">
                <div class="container-inner">
                    <?php
                    $routes = [["title" => "Home", "path" => config('app.app_path')], ["title" => "All Stores", "path" => config('app.app_path')."/stores"], ["title" => "Store Detail", "path" => ""]];
            ...
            <section class="section">
                <div class="container-inner">
                    ...
                    @web_component([ 'postfixes' => 'stores.info.style1','data' => [] ])@endweb_component
                </div>
            </section>
                    ...
                    <div class="twoColumnLayout-v1">
                        <div class="twoColumnLayout">
                            ...
                            <div class="twoColumnLayout__shortColumn">
                                ...
                                <div class="sidebar sticky js-stickySidebar">
                                                    ...
                                                    <div class="filters__wrapper">
                                                        <div class="checkboxFilter checkboxFilter--mobile">
                                                            <span class="checkboxFilter__wrapper">
                                                                ...
                                                                <label for="all-filter-default" class="checkboxFilter__label">All Products</label>
                                                            </span>
                                                        </div>
                                                        ...
                                                        <div class="checkboxFilter checkboxFilter--mobile">
                                                            <span class="checkboxFilter__wrapper">
                                                                ...
                                                                <label for="only-codes-filter-default" class="checkboxFilter__label">Coupons</label>
                                                            </span>
                                                        </div>
                                                        ...
                                                        <div class="checkboxFilter checkboxFilter--mobile">
                                                            <span class="checkboxFilter__wrapper">
                                                                ...
                                                                <label for="only-deals-filter-default" class="checkboxFilter__label">Codes</label>
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="sidebar__section onlyLargeDesktop">
                                        @web_component([ 'postfixes' => 'stores.popular.style2','data' => ['title' => 'Popular Stores'] ])@endweb_component
                                    </div>
                                    <!-- Sidebar Popular Stores Section Ends Here -->

                                    <!-- Sidebar Related Stores Section Starts Here -->
                                    <div class="sidebar__section onlyLargeDesktop">
                                        @web_component([ 'postfixes' => 'stores.popular.style2','data' => ['title' => 'Related Stores'] ])@endweb_component
                                    </div>
                            ...
                            <div class="twoColumnLayout__wideColumn">
                                    ...
                                    <div class="storeInnerGrid storeInnerGrid--category">
                                        <?php for ($i = 0; $i < 18; $i++) { ?>
                                            <div>
                                                ...
                                                @web_component([ 'postfixes' => 'categories.minimal.style3','data' => [] ])@endweb_component
                                            </div>
                                        <?php } ?>
                                    </div>
                                </section>
                                ...
                                <section class="section">
                                    @web_component([ 'postfixes' => 'coupon.active.style1','data' => [] ])@endweb_component
                                </section>
                                <!-- Active Coupons & Deals Grid Section Ends Here -->

                                <!-- Expired Coupons & Deals Grid Section Starts Here -->
                                <section class="section">
                                    @web_component([ 'postfixes' => 'coupon.expired.style1','data' => [] ])@endweb_component
                                </section>
                                ...
                                <section class="section">
                                    ...
                                    @web_component([ 'postfixes' => 'promocodes.popular.style1','data' => [] ])@endweb_component
                                </section>
                                ...
                                <section class="section">
                                    @web_component([ 'postfixes' => 'faqs.style1','data' => [] ])@endweb_component
                                </section>
            ...
            <section class="section">
                @web_component([ 'postfixes' => 'blogs.popular.style1','data' => [] ])@endweb_component
            </section>
