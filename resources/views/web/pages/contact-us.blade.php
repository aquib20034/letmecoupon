    ...
    <div class="container">
        <div class="section">
            ...
            <section class="section pd-top-none onlyDesktop">
                ...
                <?php
                    $routes = [["title" => "Home", "path" => config('app.app_path')], ["title" => "Contact us", "path" => config('app.app_path')."/contact-us"]];
                ?>
                    ...
                    <div class="contactGrid__wrapper">
                        <div class="contactGrid__left">
                            <div class="contactGrid__typography">
                                <div class="title">
                                    <h1 class="heading-1 primary m-0">Contact Us</h1>
                                </div>
                                ...
                                <form class="form" id="contactBox" method="POST"  action="{{ route('contact.store') }}" enctype="multipart/form-data">
                                    <div class="form__group">
                                        <div class="inputStyle1">
                                            ...
                                            <div class="inputStyle1__right">
                                                <input id="name" name="name" type="text" placeholder="." class="inputStyle1__input">
                                    ...
                                    <div class="form__group form__group--half">
                                        <div class="inputStyle1">
                                            ...
                                            <div class="inputStyle1__right">
                                                <input id="email" name="email" type="email" placeholder="." class="inputStyle1__input">
                                    ...
                                    <div class="form__group form__group--half">
                                        <div class="inputStyle1">
                                            ...
                                            <div class="inputStyle1__right">
                                                <input id="phone" name="phone" type="tel" placeholder="." class="inputStyle1__input">
                                    ...
                                    <div class="form__group">
                                        <div class="inputStyle1 inputStyle1--no-icon">
                                            <div class="inputStyle1__right">
                                                <textarea id="message" name="message" type="text" placeholder="." class="inputStyle1__input inputStyle1__input--textarea"></textarea>
