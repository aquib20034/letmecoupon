        ...
        <div class="section">
            ...
            <section class="section pd-none onlyDesktop">
                <div class="container-inner">
                    <?php
                    $routes = [["title" => "Home", "path" => config('app.app_path')], ["title" => "All Products", "path" => config('app.app_path')."/products"], ["title" => isset($detail['title'])?$detail['title']:"", "path" => ""]];
                            ...
                            <div class="twoColumnLayout__wideColumn">
                                ...
                                <section class="section">
                                    <div class="richTextContent-v1">
                                        <!-- 1 -->
                                        <figure>
                                            <img src="{{ ((isset($detail['product_image'])) && ($detail['product_image']!='')) ? $detail['product_image'] : config('app.image_path') . '/build/images/blog-image-1.webp' }}" alt="Review">
                                        </figure>
