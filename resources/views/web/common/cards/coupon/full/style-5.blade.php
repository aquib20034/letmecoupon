<div class="discountCardStyle5 js-discountCard {{ $coupon['code'] ? 'only-codes' : 'only-deals' }} coupon-box">
    <div @php $isExpired = false; @endphp
        class="discountCard  discountCard--{{ $variant }} {{ $isExpired ? 'discountCard--expired' : 'discountCard--active' }}">
        <div class="discountCard__border discountCard__border--1"></div>
        <div class="discountCard__border discountCard__border--2"></div>
