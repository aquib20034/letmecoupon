...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive" id="datatable-ProductCategory">
...
@parent
@php
    $url = isset(request()->test_id) ? route('admin.product-categories.index') . '?test_id=1' : route('admin.product-categories.index');
    if(isset(request()->pcid) && isset(request()->test_id)) {
        $url = $url . "&pcid=" . request()->pcid;
...
<script>
    ...
    $(function () {
        ...
        document.getElementById('siteOpt').onchange = function () {
            $("#datatable-ProductCategory").html("");
            $("#datatable-ProductCategory").html(`
