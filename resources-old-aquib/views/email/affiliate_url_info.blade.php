...
<head>
    ...
    <title>New email template 2021-05-28</title>
    <!--[if (mso 16)]>
    <style type="text/css">
    ...
    <table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;padding:0;Margin:0;width:100%;height:100%;background-repeat:repeat;background-position:center top">
        <tr style="border-collapse:collapse">
            <td valign="top" style="padding-top:20px;Margin:0">
                        ...
                        <td align="center" style="padding:0;Margin:0">
                            <table bgcolor="#ffffff" class="es-content-body" align="center" cellpadding="0" cellspacing="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;width:600px">
                                <tr style="border-collapse:collapse">
                                            ...
                                            <tr style="border-collapse:collapse">
                                                <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                                                    <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                        <tr style="border-collapse:collapse">
                                                            <td align="center" style="padding:0;Margin:0;padding-bottom:5px"><h2 style="Margin:0;line-height:29px;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;font-size:24px;font-style:normal;font-weight:bold;color:#00273D"> {{ $data['heading'] }}</h2></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                    ...
                                    <tr style="border-collapse:collapse">
                                        <td  style="Margin:0;padding:20px 20px 10px 20px;background-position:center top">
                                                                    ...
                                                                    <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;" role="presentation">
                                                                        <tr style="border-collapse:collapse;" >
                                                                            <td  style="padding:0;Margin:0;font-size:0">
                                                                                <h4 style="font-family:tahoma, verdana, segoe, sans-serif;font-size:12px;">
                                                                                    Brand : {{ $data['brand_name'] }}<br><br>
                                                                                    @if($data['coupon_name'])
                                                                                    Coupon : {{ $data['coupon_name'] }}<br><br>
                                                                                    @endif 
                                                                                    @if($data['action'] == "created")
                                                                                        Affiliate URL : {{ $data['new_affiliate_url'] }}<br> <br>                                                                          
                                                                                    @else
                                                                                        New Affiliate URL : {{ $data['new_affiliate_url'] }}<br><br>
                                                                                        Previous Affiliate URL : {{ $data['previous_affiliate_url'] }}<br><br>
                                                                                        New Network Name : {{ getNetworkName($data['new_affiliate_url']) }}<br><br>
                                                                                        Previous Network Name : {{ getNetworkName($data['previous_affiliate_url']) }}<br>                                                                                        
                                                                                    @endif                                                                             
                                                                                </h4>
                                                                            </td>
                                                                        </tr>
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-p20b" style="">
                                                                    <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;" role="presentation">
                                                                        ...
                                                                        <tr style="border-collapse:collapse">
                                                                            <td align="center" style="Margin:0;padding-top:20px;padding-bottom:5px;padding-left:10px;padding-right:10px"><span class="es-button-border" style="border-style:solid;border-color:transparent;background:#00273D;border-width:0px;display:inline-block;border-radius:0px;width:auto"><a href="https://www.letmecoupon.com/admin/show-affiliate-log/{{ encrypt($data['id']) }}" class="es-button" target="_blank" style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:14px;border-style:solid;border-color:#00273D;border-width:10px 20px 10px 20px;display:inline-block;background:#00273D;border-radius:0px;font-family:tahoma, verdana, segoe, sans-serif;font-weight:bold;font-style:normal;line-height:17px;width:auto;text-align:center">VIEW</a></span></td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                                <td class="es-hidden" style="padding:0;Margin:0;width:20px"></td>
                ...
                <table cellpadding="0" cellspacing="0" class="es-footer" align="center" style="margin-top:20px;mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;table-layout:fixed !important;width:100%;background-color:transparent;background-repeat:repeat;background-position:center top">
                    <tr style="border-collapse:collapse">
