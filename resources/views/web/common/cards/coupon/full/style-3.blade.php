<div class="discountCardStyle3 js-discountCard {{ $coupon['code'] ? 'only-codes' : 'only-deals' }} coupon-box">
    <div @php $isExpired = false; @endphp
        ...
        <div class="discountCard__wrapper">
            <div class="discountCard__innerWrapper">
                ...
                <div class="discountCard__cta">
                    <a class="baseurlappend" data-id="{{ encrypt($coupon['id']) }}"
                        data-store="{!! !empty($coupon['affiliate_url'])
                            ? addhttps($coupon['affiliate_url'])
                            : (!empty($coupon['store']['affiliate_url'])
                                ? addhttps($coupon['store']['affiliate_url'])
                                : addhttps($coupon['store']['store_url'])) !!}" data-var="{{ $coupon['code'] ? 'copy' : 'deal' }}"
