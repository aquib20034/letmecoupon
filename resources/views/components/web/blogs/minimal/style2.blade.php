        ...
        <div class="card__wrapper">
            <div class="card__left">
                <div class="card__thumbnail">
                    <a href="{{ config('app.app_path') }}/{{ isset($blog['slugs']) ? $blog['slugs']['slug'] : '' }}" class="card__tag" aria-label="Visit Blog Page">
                        <span>
                            Blog
                        </span>
                    </a>
            ...
            <div class="card__bottom">
                ...
                <div class="card__title">
                    <h2>
                        <a href="{{ config('app.app_path') }}/{{ isset($blog['slugs']) ? $blog['slugs']['slug'] : '' }}" aria-label="Visit Blog Inner Page">{{ isset($blog['title']) ? $blog['title'] : "" }}</a>
                    </h2>
                </div>

                <div class="card__attributes">
                    <span>
                        <a aria-label="Visit Author Page">{{ isset($blog['user']['name'] ) ? $blog['user']['name']  :""}}</a>
                    </span>
