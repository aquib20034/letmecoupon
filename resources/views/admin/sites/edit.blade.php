            ...
            <form method="POST" action="{{ route('admin.sites.update', [$site->id]) }}" enctype="multipart/form-data"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name"
                        id="name" value="{{ old('name', $site->name) }}" required>
                    @if ($errors->has('name'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('country_name') ? 'is-invalid' : '' }}" type="text"
                        name="country_name" id="country_name" value="{{ old('country_name', $site->country_name) }}"
                        required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('country_code') ? 'is-invalid' : '' }}" type="text"
                        name="country_code" id="country_code" value="{{ old('country_code', $site->country_code) }}"
                        required>
                        ...
                        @if (count($language) > 0)
                            @foreach ($language as $id => $item)
                                <option value="{{ $item['code'] }}"
                                    {{ ($site->language_code ? $site->language_code : old('language_code')) == $item['code'] ? 'selected' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('url') ? 'is-invalid' : '' }}" type="text" name="url"
                        id="url" value="{{ old('url', $site->url) }}" required>
                    @if ($errors->has('url'))
                        <div class="invalid-feedback">
                            {{ $errors->first('url') }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('javascript_tags') ? 'is-invalid' : '' }}" name="javascript_tags"
                        id="javascript_tags">{{ old('javascript_tags', $site->javascript_tags) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('meta_title') ? 'is-invalid' : '' }}" type="text"
                        name="meta_title" id="meta_title" value="{{ old('meta_title', $site->meta_title) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('meta_keywords') ? 'is-invalid' : '' }}" type="text"
                        name="meta_keywords" id="meta_keywords" value="{{ old('meta_keywords', $site->meta_keywords) }}"
                        required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('meta_description') ? 'is-invalid' : '' }}" type="text"
                        ...
                        value="{{ old('meta_description', $site->meta_description) }}" required maxlength="500"
                        minlength="70">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('about_desc') ? 'is-invalid' : '' }}" name="about_desc"
                        id="about_desc"> {!! old('about_desc', $site->about_desc) !!} </textarea>
                ...
                <div class="form-group">
                    <div class="form-check {{ $errors->has('publish') ? 'is-invalid' : '' }}">
                        ...
                        <input class="form-check-input" type="checkbox" name="publish" id="publish" value="1"
                            {{ $site->publish || old('publish', 0) === 1 ? 'checked' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('store_heading_one_suffix') ? 'is-invalid' : '' }}"
                        ...
                        value="{{ old('store_heading_one_suffix', $site->store_heading_one_suffix) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('primary_keyword') ? 'is-invalid' : '' }}" type="text"
                        ...
                        value="{{ old('primary_keyword', $site->primary_keyword) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('secondary_keyword') ? 'is-invalid' : '' }}"
                        ...
                        value="{{ old('secondary_keyword', $site->secondary_keyword) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('store_meta_title_template') ? 'is-invalid' : '' }}"
                        ...
                        value="{{ old('store_meta_title_template', $site->store_meta_title_template) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('store_meta_description_template') ? 'is-invalid' : '' }}"
                        ...
                        value="{{ old('store_meta_description_template', $site->store_meta_description_template) }}"
                        required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('category_page_title_template') ? 'is-invalid' : '' }}"
                        ...
                        value="{{ old('category_page_title_template', $site->category_page_title_template) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('category_meta_title_template') ? 'is-invalid' : '' }}"
                        ...
                        value="{{ old('category_meta_title_template', $site->category_meta_title_template) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        value="{{ old('category_meta_description_template', $site->category_meta_description_template) }}"
                        required>
