...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive" id="datatable-AddSpaceProduct">
...
@section('scripts')
    @parent
    @php
        $url = isset(request()->test_id) ? route('admin.add-space-products.index') . '?test_id=1' : route('admin.add-space-products.index');
    ...
    <script>
        ...
        $(function () {
            ...
            $('.datatable-AddSpaceProduct').DataTable(dtOverrideGlobals);
            ...
            document.getElementById('siteOpt').onchange = function () {
                $("#datatable-AddSpaceProduct").html("");
                $("#datatable-AddSpaceProduct").html(`
                        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-AddSpaceProduct">
                            <thead>
                                <tr>
                                    <th width="10">
