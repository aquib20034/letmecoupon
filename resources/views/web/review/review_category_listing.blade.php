    ...
    <div class="container">
        <div class="section">
            ...
            <section class="section pd-none onlyDesktop">
                ...
                <?php
                    $routes = [["title" => "Home", "path" => config('app.app_path')], ["title" => trans('sentence.review_all_cats'), "path" => config('app.app_path')."/review-categories"]];
            ...
            @if(isset($categories) && count($categories) > 0)
                ...
                <div class="section">
                    <div class="container-inner">
                        <div>
                            <h2 class="heading-1 primary">{{trans('sentence.review_all_cats')}}</h2>
                        </div>
                                        ...
                                        <ul class="popularListing__list">
                                            @foreach($categories as $key => $category)
                                                <li class="popularListing__listItem">
                                                    ...
                                                    @web_component([ 'postfixes' => 'reviews.review-categories.style1','data' => [ 'category' => $category ] ])@endweb_component
                                                </li>
                                            @endforeach
                                        </ul>
