    ...
    <div class="container">
        <div class="section">
            ...
            <section class="section pd-none onlyDesktop">
                ...
                <?php
                    $routes = [["title" => "Home", "path" => config('app.app_path')], ["title" => "All Authors", "path" => config('app.app_path')."/authors"]];
            ...
            <!-- All Authors Listing Section Starts Here -->
            <div class="section">
                <div class="container-inner">
                    <div>
                        <h2 class="heading-1 primary">All Authors</h2>
                    </div>
                            ...
                            <div class="popularListing__wrapper">
                                <div class="popularListing__content">
                                        ...
                                        @if (isset($authors)) 
                                            @foreach ($authors as $author)
                                                    ...
                                                    <li class="popularListing__listItem">
                                                        ...
                                                        @web_component([ 'postfixes' => 'authors.minimal.style2','data' => ['author'=>$author, 'variant' => $variant] ])@endweb_component
                                                    </li>
                                            @endforeach
                                        @endif
                                    </ul>
                                    ...
                                    <div class="popularListing__gridCta onlyMobile">
                                        <a href="{{ config('app.app_path') }}/authors" class="btn-1" aria-label="View All">View All</a>
                                    </div>
                                </div>
                            </div>
