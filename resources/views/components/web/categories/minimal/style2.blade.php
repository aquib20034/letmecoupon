...
<div class="cardStyle4">
    @php($variant = '1')
    <a href="{{ config('app.app_path')}}/{{isset($category['slugs'])?($category['slugs']['slug'])?$category['slugs']['slug']:'':''}}" class="card  card--{{$variant}}" aria-label="Visit {{isset($category['title'])?$category['title']:''}} Page" draggable="false">
