    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.categories.store") }}" enctype="multipart/form-data" id="categoryForm">
            ...
            <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-10">
                        ...
                        <input type="hidden" id="parnt_slug" name="parnt_slug" value=""/>
                        @if($errors->has('slug'))
                            <div class="invalid-feedback">
                                {{ $errors->first('slug') }}
                            </div>
            ...
            <div class="form-group">
                ...
                <div class="needsclick dropzone {{ $errors->has('category_banner_image') ? 'is-invalid' : '' }}" id="category-banner-image-dropzone">
                </div>
            ...
            <div class="form-group">
                ...
                <div class="needsclick dropzone {{ $errors->has('category_coupon_image') ? 'is-invalid' : '' }}" id="category-coupon-image-dropzone">
                </div>
            ...
            <div class="form-group">
                ...
                <div class="needsclick dropzone {{ $errors->has('category_blog_image') ? 'is-invalid' : '' }}" id="category-blog-image-dropzone">
                </div>
            ...
            <div class="form-group">
                ...
                @endif
                <span class="help-block float-left">{{ trans('cruds.category.fields.meta_description_helper') }}</span>
    ...
    $(document).ready(function(){
        $('#parent_id').change(function(){
            ...
            $.ajax({
                ...
                var parnt_slug = $('#parnt_slug').attr("value", response);
                /*$(".org_slug").val(function() {
                    return response+old_val;
                });*/
            });
        });
    });
    Dropzone.options.categoryBannerImageDropzone = {
        ...
        init: function () {
            @if(isset($category) && $category->category_banner_image)
                ...
                this.options.addedfile.call(this, file)
                this.options.thumbnail.call(this, file, '{{ $category->category_banner_image->getUrl('thumb') }}')
                file.previewElement.classList.add('dz-complete')
    ...
    Dropzone.options.categoryBlogImageDropzone = {
        ...
        init: function () {
            @if(isset($category) && $category->category_blog_image)
                ...
                this.options.addedfile.call(this, file)
                this.options.thumbnail.call(this, file, '{{ $category->category_blog_image->getUrl('thumb') }}')
                file.previewElement.classList.add('dz-complete')
